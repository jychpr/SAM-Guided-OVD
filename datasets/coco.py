...
class CocoDetection(torchvision.datasets.CocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        # --- THESIS: Inject FastSAM Priors into DataLoader ---
        prior_file = f"output/coco2017/sam_priors_train2017/{image_id}.pt"
        if os.path.exists(prior_file):
            target['sam_proposals'] = torch.load(prior_file)
        else:
            # Fallback for validation set or missing caches
